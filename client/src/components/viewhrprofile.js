  ...
  return (
    <div>
      ...
      >
        ...
        >
          <div className=" offset-1  col-md-3 ">Name : {name}</div>
        </div>
        <div
          className="row"
          style={{
        ...
        >
          <div className="col-11 offset-1 col-md-2 ">Role : {role}</div>
        </div>
        {faculty === "" ? (
          <div></div>
        ) : (
        ...
        {department === "" ? (
          ...
          >
            <div className=" offset-1 col-md-3 ">Department : {department}</div>
          </div>
        )}
