...
import './bellwhite.css'
import BellIcon from 'react-bell-icon';
import axios from "axios";
import Swal from 'sweetalert2'
function Hrnavbarnotification() {
...
const handlesignout = async(e) => {
  ...
  Swal.fire({
    ...
    return (
      ...
      <Nav.Link className= 'gg' href='/#'> <BellIcon width='20' height='20' active={true} animate={false} fill='#FFF'/> </Nav.Link>
...
export default Hrnavbarnotification;