...
export default function Viewmyprofile() {
  ...
  const handleresetclick = async (e) => {
   ...
   useEffect(async() => {
     ...
     await axios({
        ...
        setOfficelocation(
          res.data.existingUser.officelocation == undefined
            ? ""
            : res.data.existingUser.officelocation.locname
        );
  ...
  return (
    <div>
      ...
      <div
        className="card"
        style={{ marginTop: "20px", backgroundColor: "#F4F4F0" }}
      >
        <div
          className="row"
          style={{
        ...
        >
          <div className="col-11 offset-1  col-md-2 ">Name : {name}</div>
        </div>
        <div
          className="row"
          style={{
        ...
        >
          <div className="col-11 offset-1 col-md-2 ">id : {id}</div>
        ...
        >
          <div className=" offset-1 col-md-3 ">E-Mail : {email}</div>
          {/* <div className="col-11 offset-1 col-md-4" >
        ...
        >
          <div className="col-11 offset-1 col-md-2 ">Salary : {salary}</div>
          {/* <div className="col-11 offset-1 col-md-4" >
        ...
        >
          <div className="col-11 offset-1 col-md-2 ">Gender : {gender}</div>
        </div>
        <div
          className="row"
          style={{
        ...
        >
          <div className="col-11 offset-1 col-md-2 ">dayoff : {dayoff}</div>
        </div>
        ...
        >
          <div className=" offset-1 col-md-3 ">Role : {role}</div>
        </div>
        {faculty === "" ? (
          <div></div>
        ) : (
          ...
          >
            <div className=" offset-1 col-md-3 ">Faculty : {faculty}</div>
          </div>
        )}
        {department === "" ? (
          <div></div>
        ...
        >
          <div className=" offset-1 col-md-3 ">Bio : {bio}</div>
        </div>
      </div>
      ...
      <Modal show={showreset} centered onHide={sendReset}>
      ...
      <Modal show={showupdate} centered onHide={ResetUpdate}>
        <Modal.Header closeButton>
