    ...
    try {
      ...
      await axios({
        ...
        if (!res.data.msg) {
          ...
          this.setState({  repcourse: res.data.request.receiver == undefined ? " " : res.data.request.receiver.id });
          this.setState({ repslottime: res.data.request.slottime });
          this.setState({ repweekday: res.data.request.weekday });
          this.setState({ repcourse: res.data.request.course == undefined ? " " : res.data.request.course.id });
  ...
  render() {
    return (
      ...
      >
        ...
        <td>
          {" "}
          {this.props.reqData.receiver == undefined
            ? " "
            : this.props.reqData.receiver.id}{" "}
        </td>
          ...
          <Modal.Body>
            <Table responsive>
              ...
              <tbody>
                ...
                >
                  <td>
                    {this.state.repreceiver == undefined
                      ? " "
                      : this.state.repreceiver}
                  </td>

                  <td>{this.state.repslottime}</td>
                  <td>{this.state.repweekday}</td>
                  <td>
                    {this.state.repcourse == undefined
                      ? " "
                      : this.state.repcourse}
                  </td>
