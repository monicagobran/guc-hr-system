...
class SlotsRow extends Component {
  ...
  resetUpdate() {
    ...
    this.setState({ locationUpdate:  this.props.slotsData.location == undefined ? "": this.props.slotsData.location.locname});
  }
  ...
  render() {
    return (
      ...
      >
        ...
        <td>
          {this.props.slotsData.location == undefined
            ? ""
            : this.props.slotsData.location.locname}{" "}
        </td>
        <td>
        ...
        <td>
          ...
          >
            <Modal.Header closeButton>
              <h4 style={{ textAlign: "center" }}>Update Slot {this.props.slotsData.id} </h4>
            </Modal.Header>
            <Modal.Body>
              <Container>
                <Row>
