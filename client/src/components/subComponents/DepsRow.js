...
class DepsRow extends Component {
  ...
  addLoc() {
    ...
    this.setState({ depfacultyUpdate: this.props.depData.faculty === undefined ? "" : this.props.depData.faculty.name } );
  ...
  render() {
    return (
          ...
          >
            ...
            <td> {(this.props.depData.name === undefined)? "" : this.props.depData.name}</td>
            <td> {(this.props.depData.faculty === undefined)? "" : this.props.depData.faculty.name}</td>
            <td> {(this.props.depData.head === undefined)? "" : this.props.depData.head.name}</td>
            ...
            <Modal.Body>
              ...
              <Row>
                  <Form.Group as={Col}>
                    ...
                    <Form.Control
                      defaultValue={(this.props.depData.name === undefined)? "" : this.props.depData.name}
                      onChange={(e) => {
                  ...
                  <Form.Group as={Col}>
                    ...
                    <Form.Control
                      defaultValue= {(this.props.depData.faculty === undefined)? "" : this.props.depData.faculty.name}
                      onChange={(e) => {
