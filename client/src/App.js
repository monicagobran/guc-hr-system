              ...
              {localStorage.getItem("tokenrole") === "HR" ? (
                <Switch>
                  ...
                  <Route
                    exact
                    path="/viewhrprofile"
                    component={Viewhrprofile}
                  />
                  <Route
                    exact
                    path="/viewhrattendence"
                    component={Viewhrattendence}
                  />
                  <Route
                    exact
                    path="/viewhrnorifications"
                    component={Viewhrnotifications}
                  />
                ...
                <Switch>
                  {localStorage.getItem("tokenrole") === "HOD" ? (
                    <Switch>
                      ...
                      <Route
                        exact
                        path="/changedayoffrequests"
                        component={ChangedayOffRequests}
                      />
                      <Route
                        exact
                        path="/managecourses"
                      ...
                      <Route
                        exact
                        path="/instructorslots"
                        component={Instructorslots}
                      />
                    ...
                    <Switch>
                      {localStorage.getItem("tokenrole") ===
                      "Course coordinator" ? (
                        <Switch>
                          {/*ALL USERS  */}
                          <Route
